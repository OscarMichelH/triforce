class ShipmentsController < ApplicationController
  ...
  private
    ...
    def shipment_params
      params.require(:shipment).permit(:name, :email, :phone_number, :address, :city, :zipcode, :country, :track_number, :status, :method, :payment_id, :payment_type, :collection_id, :collection_status, :preference_id, :merchant_order_id, :cart_id)
    end
end
